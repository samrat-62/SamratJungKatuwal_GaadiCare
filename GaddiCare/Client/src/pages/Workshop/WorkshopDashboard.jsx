...
import { fetchAlerts, markAllAlertsRead, deleteAlert, clearAllAlerts } from "@/store/slice/getNotifications.jsx"
...
const WorkshopDashboard = () => {
  ...
  const workshopBookings = bookings?.filter(booking => booking?.workshopId === user?._id && booking?.status === 'pending')?.length;
  ...
  return (
    <div className='flex min-h-screen bg-gray-50'>
      <WorkshopSidebar serviceRequestsCount={workshopBookings}/>
