...
import { Calendar, CheckCircle, ChevronLeft, ChevronRight, Eye, Loader2, Mail, MapPin, Phone, Search, XCircle } from "lucide-react";
  ...
  const filteredWorkshops = useMemo(() => {
    ...
    if (dateRange.from && dateRange.to) {
      filtered = filtered.filter(workshop => {
        ...
        return workshopDate >= dateRange.from && workshopDate <= dateRange.to;
      });
    }
    
    return filtered;
  }, [workshopsArray, searchQuery, dateRange]);
    ...
    <div>
      <div className="mb-8">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Pending Workshop Approvals</h1>
            <p className="text-gray-600 mt-2">Review and manage new workshop registration requests</p>
          </div>
